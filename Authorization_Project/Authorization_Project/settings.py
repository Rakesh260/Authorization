...
SECRET_KEY = 'django-insecure-jkt&j6s9de8pv)4s20*q3fbsbyu65g8ytw0av2ze5$7mqf!h(t'
...
ROOT_URLCONF = 'Authorization_Project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "templates"],  # Adjust if you have a custom template directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Authorization_Project.wsgi.application'
